...
class LearningRateDecay(Callback):
    ...
    def __init__(self, name='polynomial_decay', learning_rate=0.001, decay_steps=1000, decay_rate=0.95, min_delta=1e-4,
                 verbose=0, staircase=True, power=0.5, end_learning_rate=5e-6, to_min=4, cycle=True):
    ...
    def on_batch_begin(self, batch, logs=None):
        ...
        if self.name in function1:
            ...
            lr = decay_function(self.learning_rate, self.global_step, self.decay_steps, self.end_learning_rate,
                                self.power, self.cycle)
