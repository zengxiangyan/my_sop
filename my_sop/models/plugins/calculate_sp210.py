...
class main(calculate_sp.main):
    ...
    def start(self, batch_now, read_data, other_info=None):
        ...
        for row in self.read_data:
            ...
            if not (f_map['snum'] == 24 and f_map['date'] >= '2022-01-01' and f_map['date'] < '2023-06-01'):
                ...
                if info != None:
                    ...
                    if month_str >= info['start_month'] and month_str <= info['end_month'] and sp[1] == info['sp1'] and f_map['source'] == info['platform']:
    ...
    def init_read_require(self):
        ...
        sql = 'select start_month, end_month, sp1, platform, item_id, trade_value, all_bid_sp from clean_210_update_bid'
        ...
        sql = 'select start_month, end_month, platform, item_id, trade_value, sub_batch_id, sp1 from clean_210_update_sp1'
        for row in self.batch_now.db_cleaner.query_all(sql):
