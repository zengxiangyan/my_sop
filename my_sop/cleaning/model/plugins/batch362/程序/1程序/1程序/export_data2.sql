...
JOIN makeupall32 m32 ON (m3.newno = m32.newno)
SET m3.brand7 = m32.brand6
where m32.brand6 IN (SELECT * FROM tbrand) and not isnull(m32.brand6) and m32.brand6 != "" and m32.brand6 != "TBD"
...
-- 5.出数据（brand）
SELECT m3.brand7, m2.platform, m2.newno, m2.`time`, m2.c4, m2.name, m2.brand, 
