...
def unit_classfiy(prefix):
    ...
    category_classifier.load_rules("../../../rules/rules.xlsx", sheet_name="category.rule" + '')
    brand_classifier.load_rules("../../../rules/rules.xlsx", "brand.rule" + '')
...
def Bar2(task_id):
    ...
    progress_record, created = CleanCron.objects.get_or_create(task_id=task_id, batch_id=362, eid=10716, emergency=0,status='process', type='清洗品牌1')
    progress_record.msg = '清洗品牌1：{}/{}'.format(pbar.n, pbar.total)
